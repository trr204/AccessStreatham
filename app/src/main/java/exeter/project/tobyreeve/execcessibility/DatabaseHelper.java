...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String sql = "CREATE TABLE " + BUILDING_TABLE_NAME + " (" +
                BUILDING_TABLE_COLUMN_ONE + " INTEGER PRIMARY KEY AUTOINCREMENT," +
                BUILDING_TABLE_COLUMN_TWO + " TEXT," +
                BUILDING_TABLE_COLUMN_THREE + " TEXT)";
        db.execSQL(sql);
        sql = "CREATE TABLE " + FEATURE_TABLE_NAME + " (" +
                FEATURE_TABLE_COLUMN_ONE + " INTEGER PRIMARY KEY AUTOINCREMENT," +
                FEATURE_TABLE_COLUMN_TWO + " INTEGER," +
                FEATURE_TABLE_COLUMN_THREE + " TEXT," +
                FEATURE_TABLE_COLUMN_FOUR + " TEXT," +
                "FOREIGN KEY("+FEATURE_TABLE_COLUMN_TWO+") REFERENCES "+BUILDING_TABLE_NAME+"("+BUILDING_TABLE_COLUMN_ONE+"))";
        db.execSQL(sql);
        populateBuildingData(db, "Harrison", "Home of CompSci");
        populateBuildingData(db, "Amory", "A labyrinth");
        populateBuildingData(db, "Forum", "The heart of Streatham");
        populateBuildingData(db, "Newman", "Colour-coded lecture theatres");
        populateBuildingData(db, "Physics", "A giant");
        populateBuildingData(db, "Great Hall", "A hall that is great");
        populateBuildingData(db, "Library", "Chamber of knowledge");
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        populateEdgeData(db, "27314280","299822428","299822428");
        populateEdgeVertexJoinData(db, "27314280", "299822428",0);
        populateEdgeVertexJoinData(db, "27314280", "299822429",1);
        populateEdgeVertexJoinData(db, "27314280", "299822430",2);
        populateEdgeVertexJoinData(db, "27314280", "4695334939",3);
        populateEdgeVertexJoinData(db, "27314280", "299822431",4);
        populateEdgeVertexJoinData(db, "27314280", "299822432",5);
        populateEdgeVertexJoinData(db, "27314280", "299822433",6);
        populateEdgeVertexJoinData(db, "27314280", "299822434",7);
        populateEdgeVertexJoinData(db, "27314280", "299822435",8);
        populateEdgeVertexJoinData(db, "27314280", "299822428",9);
        populateEdgeData(db, "27314281","299822436","299822436");
        populateEdgeVertexJoinData(db, "27314281", "299822436",0);
        populateEdgeVertexJoinData(db, "27314281", "299825633",1);
        populateEdgeVertexJoinData(db, "27314281", "4432912550",2);
        populateEdgeVertexJoinData(db, "27314281", "299822438",3);
        populateEdgeVertexJoinData(db, "27314281", "4432912554",4);
        populateEdgeVertexJoinData(db, "27314281", "4432912558",5);
        populateEdgeVertexJoinData(db, "27314281", "299825634",6);
        populateEdgeVertexJoinData(db, "27314281", "299822436",7);
        populateEdgeData(db, "27314305","299822794","299822794");
        populateEdgeVertexJoinData(db, "27314305", "299822794",0);
        populateEdgeVertexJoinData(db, "27314305", "299822795",1);
        populateEdgeVertexJoinData(db, "27314305", "299822796",2);
        populateEdgeVertexJoinData(db, "27314305", "299822797",3);
        populateEdgeVertexJoinData(db, "27314305", "2179870955",4);
        populateEdgeVertexJoinData(db, "27314305", "2179870954",5);
        populateEdgeVertexJoinData(db, "27314305", "299822794",6);
        populateEdgeData(db, "27314451","299823749","299823749");
        populateEdgeVertexJoinData(db, "27314451", "299823749",0);
        populateEdgeVertexJoinData(db, "27314451", "299823750",1);
        populateEdgeVertexJoinData(db, "27314451", "299824962",2);
        populateEdgeVertexJoinData(db, "27314451", "299823752",3);
        populateEdgeVertexJoinData(db, "27314451", "299823808",4);
        populateEdgeVertexJoinData(db, "27314451", "299824965",5);
        populateEdgeVertexJoinData(db, "27314451", "299823810",6);
        populateEdgeVertexJoinData(db, "27314451", "299825074",7);
        populateEdgeVertexJoinData(db, "27314451", "299823749",8);
        ...
        populateEdgeData(db, "27315944","299834910","299834910");
        populateEdgeVertexJoinData(db, "27315944", "299834910",0);
        populateEdgeVertexJoinData(db, "27315944", "299834482",1);
        populateEdgeVertexJoinData(db, "27315944", "299834832",2);
        populateEdgeVertexJoinData(db, "27315944", "299835014",3);
        populateEdgeVertexJoinData(db, "27315944", "1853359434",4);
        populateEdgeVertexJoinData(db, "27315944", "1853359431",5);
        populateEdgeVertexJoinData(db, "27315944", "1853359959",6);
        populateEdgeVertexJoinData(db, "27315944", "1853359415",7);
        populateEdgeVertexJoinData(db, "27315944", "1853359422",8);
        populateEdgeVertexJoinData(db, "27315944", "1853359925",9);
        populateEdgeVertexJoinData(db, "27315944", "299834835",10);
        populateEdgeVertexJoinData(db, "27315944", "299835446",11);
        populateEdgeVertexJoinData(db, "27315944", "299834486",12);
        populateEdgeVertexJoinData(db, "27315944", "299835015",13);
        populateEdgeVertexJoinData(db, "27315944", "299834488",14);
        populateEdgeVertexJoinData(db, "27315944", "299834489",15);
        populateEdgeVertexJoinData(db, "27315944", "299834491",16);
        populateEdgeVertexJoinData(db, "27315944", "299834493",17);
        populateEdgeVertexJoinData(db, "27315944", "299834914",18);
        populateEdgeVertexJoinData(db, "27315944", "299834495",19);
        populateEdgeVertexJoinData(db, "27315944", "299834496",20);
        populateEdgeVertexJoinData(db, "27315944", "299834498",21);
        populateEdgeVertexJoinData(db, "27315944", "299834838",22);
        populateEdgeVertexJoinData(db, "27315944", "299834501",23);
        populateEdgeVertexJoinData(db, "27315944", "1853359923",24);
        populateEdgeVertexJoinData(db, "27315944", "299835037",25);
        populateEdgeVertexJoinData(db, "27315944", "1853359937",26);
        populateEdgeVertexJoinData(db, "27315944", "299834841",27);
        populateEdgeVertexJoinData(db, "27315944", "299834917",28);
        populateEdgeVertexJoinData(db, "27315944", "299835108",29);
        populateEdgeVertexJoinData(db, "27315944", "299834844",30);
        populateEdgeVertexJoinData(db, "27315944", "1853359915",31);
        populateEdgeVertexJoinData(db, "27315944", "1853359917",32);
        populateEdgeVertexJoinData(db, "27315944", "299834508",33);
        populateEdgeVertexJoinData(db, "27315944", "1853359758",34);
        populateEdgeVertexJoinData(db, "27315944", "1853359765",35);
        populateEdgeVertexJoinData(db, "27315944", "1853359766",36);
        populateEdgeVertexJoinData(db, "27315944", "1853359764",37);
        populateEdgeVertexJoinData(db, "27315944", "299834918",38);
        populateEdgeVertexJoinData(db, "27315944", "299834849",39);
        populateEdgeVertexJoinData(db, "27315944", "299835156",40);
        populateEdgeVertexJoinData(db, "27315944", "299834513",41);
        populateEdgeVertexJoinData(db, "27315944", "299834852",42);
        populateEdgeVertexJoinData(db, "27315944", "299834515",43);
        populateEdgeVertexJoinData(db, "27315944", "1853359761",44);
        populateEdgeVertexJoinData(db, "27315944", "299834517",45);
        populateEdgeVertexJoinData(db, "27315944", "1853359763",46);
        populateEdgeVertexJoinData(db, "27315944", "1853359826",47);
        populateEdgeVertexJoinData(db, "27315944", "1853359814",48);
        populateEdgeVertexJoinData(db, "27315944", "299834518",49);
        populateEdgeVertexJoinData(db, "27315944", "299834519",50);
        populateEdgeVertexJoinData(db, "27315944", "299834520",51);
        populateEdgeVertexJoinData(db, "27315944", "1853359855",52);
        populateEdgeVertexJoinData(db, "27315944", "1853359848",53);
        populateEdgeVertexJoinData(db, "27315944", "1853359818",54);
        populateEdgeVertexJoinData(db, "27315944", "299834854",55);
        populateEdgeVertexJoinData(db, "27315944", "299834910",56);
        ...
        populateEdgeData(db, "27316606","299839687","299839687");
        populateEdgeVertexJoinData(db, "27316606", "299839687",0);
        populateEdgeVertexJoinData(db, "27316606", "299839017",1);
        populateEdgeVertexJoinData(db, "27316606", "299839688",2);
        populateEdgeVertexJoinData(db, "27316606", "1792436626",3);
        populateEdgeVertexJoinData(db, "27316606", "1792436677",4);
        populateEdgeVertexJoinData(db, "27316606", "301171438",5);
        populateEdgeVertexJoinData(db, "27316606", "299839020",6);
        populateEdgeVertexJoinData(db, "27316606", "299840170",7);
        populateEdgeVertexJoinData(db, "27316606", "1792436668",8);
        populateEdgeVertexJoinData(db, "27316606", "301171440",9);
        populateEdgeVertexJoinData(db, "27316606", "1792436573",10);
        populateEdgeVertexJoinData(db, "27316606", "299839023",11);
        populateEdgeVertexJoinData(db, "27316606", "299840972",12);
        populateEdgeVertexJoinData(db, "27316606", "299840973",13);
        populateEdgeVertexJoinData(db, "27316606", "299840974",14);
        populateEdgeVertexJoinData(db, "27316606", "1792436360",15);
        populateEdgeVertexJoinData(db, "27316606", "1792436521",16);
        populateEdgeVertexJoinData(db, "27316606", "1792436679",17);
        populateEdgeVertexJoinData(db, "27316606", "1792436442",18);
        populateEdgeVertexJoinData(db, "27316606", "299841339",19);
        populateEdgeVertexJoinData(db, "27316606", "299840975",20);
        populateEdgeVertexJoinData(db, "27316606", "299840976",21);
        populateEdgeVertexJoinData(db, "27316606", "299841359",22);
        populateEdgeVertexJoinData(db, "27316606", "299840977",23);
        populateEdgeVertexJoinData(db, "27316606", "299839687",24);
        ...
        populateEdgeData(db, "27919104","306475187","306475187");
        populateEdgeVertexJoinData(db, "27919104", "306475187",0);
        populateEdgeVertexJoinData(db, "27919104", "306475188",1);
        populateEdgeVertexJoinData(db, "27919104", "306475189",2);
        populateEdgeVertexJoinData(db, "27919104", "306475190",3);
        populateEdgeVertexJoinData(db, "27919104", "306475191",4);
        populateEdgeVertexJoinData(db, "27919104", "306475192",5);
        populateEdgeVertexJoinData(db, "27919104", "306475193",6);
        populateEdgeVertexJoinData(db, "27919104", "1853359428",7);
        populateEdgeVertexJoinData(db, "27919104", "1853359919",8);
        populateEdgeVertexJoinData(db, "27919104", "1853359421",9);
        populateEdgeVertexJoinData(db, "27919104", "306475194",10);
        populateEdgeVertexJoinData(db, "27919104", "306475195",11);
        populateEdgeVertexJoinData(db, "27919104", "306475196",12);
        populateEdgeVertexJoinData(db, "27919104", "1853359429",13);
        populateEdgeVertexJoinData(db, "27919104", "1853359985",14);
        populateEdgeVertexJoinData(db, "27919104", "1853359976",15);
        populateEdgeVertexJoinData(db, "27919104", "1853359963",16);
        populateEdgeVertexJoinData(db, "27919104", "306475197",17);
        populateEdgeVertexJoinData(db, "27919104", "1853359983",18);
        populateEdgeVertexJoinData(db, "27919104", "306475198",19);
        populateEdgeVertexJoinData(db, "27919104", "306475199",20);
        populateEdgeVertexJoinData(db, "27919104", "1853359419",21);
        populateEdgeVertexJoinData(db, "27919104", "1853359423",22);
        populateEdgeVertexJoinData(db, "27919104", "1853359472",23);
        populateEdgeVertexJoinData(db, "27919104", "1853359430",24);
        populateEdgeVertexJoinData(db, "27919104", "1853359469",25);
        populateEdgeVertexJoinData(db, "27919104", "1853359981",26);
        populateEdgeVertexJoinData(db, "27919104", "306475187",27);
        populateEdgeData(db, "27919393","306477783","306477783");
        populateEdgeVertexJoinData(db, "27919393", "306477783",0);
        populateEdgeVertexJoinData(db, "27919393", "306477784",1);
        populateEdgeVertexJoinData(db, "27919393", "306477785",2);
        populateEdgeVertexJoinData(db, "27919393", "306477786",3);
        populateEdgeVertexJoinData(db, "27919393", "306477787",4);
        populateEdgeVertexJoinData(db, "27919393", "306477788",5);
        populateEdgeVertexJoinData(db, "27919393", "306477789",6);
        populateEdgeVertexJoinData(db, "27919393", "306477790",7);
        populateEdgeVertexJoinData(db, "27919393", "306477791",8);
        populateEdgeVertexJoinData(db, "27919393", "306477792",9);
        populateEdgeVertexJoinData(db, "27919393", "306477793",10);
        populateEdgeVertexJoinData(db, "27919393", "306477794",11);
        populateEdgeVertexJoinData(db, "27919393", "306477795",12);
        populateEdgeVertexJoinData(db, "27919393", "306477796",13);
        populateEdgeVertexJoinData(db, "27919393", "306477797",14);
        populateEdgeVertexJoinData(db, "27919393", "306477798",15);
        populateEdgeVertexJoinData(db, "27919393", "306477799",16);
        populateEdgeVertexJoinData(db, "27919393", "306477802",17);
        populateEdgeVertexJoinData(db, "27919393", "306477783",18);
        ...
        populateEdgeData(db, "38387668","453654365","453654365");
        populateEdgeVertexJoinData(db, "38387668", "453654365",0);
        populateEdgeVertexJoinData(db, "38387668", "453654466",1);
        populateEdgeVertexJoinData(db, "38387668", "453654363",2);
        populateEdgeVertexJoinData(db, "38387668", "453654408",3);
        populateEdgeVertexJoinData(db, "38387668", "453654407",4);
        populateEdgeVertexJoinData(db, "38387668", "2164324921",5);
        populateEdgeVertexJoinData(db, "38387668", "453654398",6);
        populateEdgeVertexJoinData(db, "38387668", "453654410",7);
        populateEdgeVertexJoinData(db, "38387668", "3358152706",8);
        populateEdgeVertexJoinData(db, "38387668", "453654414",9);
        populateEdgeVertexJoinData(db, "38387668", "3303071051",10);
        populateEdgeVertexJoinData(db, "38387668", "445446336",11);
        populateEdgeVertexJoinData(db, "38387668", "453654413",12);
        populateEdgeVertexJoinData(db, "38387668", "3303996377",13);
        populateEdgeVertexJoinData(db, "38387668", "453654404",14);
        populateEdgeVertexJoinData(db, "38387668", "3302489684",15);
        populateEdgeVertexJoinData(db, "38387668", "453654416",16);
        populateEdgeVertexJoinData(db, "38387668", "3302485179",17);
        populateEdgeVertexJoinData(db, "38387668", "4849659889",18);
        populateEdgeVertexJoinData(db, "38387668", "4849659883",19);
        populateEdgeVertexJoinData(db, "38387668", "1309354322",20);
        populateEdgeVertexJoinData(db, "38387668", "453654396",21);
        populateEdgeVertexJoinData(db, "38387668", "453654391",22);
        populateEdgeVertexJoinData(db, "38387668", "1676121038",23);
        populateEdgeVertexJoinData(db, "38387668", "2272033430",24);
        populateEdgeVertexJoinData(db, "38387668", "453654387",25);
        populateEdgeVertexJoinData(db, "38387668", "453654395",26);
        populateEdgeVertexJoinData(db, "38387668", "453654401",27);
        populateEdgeVertexJoinData(db, "38387668", "453654399",28);
        populateEdgeVertexJoinData(db, "38387668", "453654393",29);
        populateEdgeVertexJoinData(db, "38387668", "2275369656",30);
        populateEdgeVertexJoinData(db, "38387668", "3208663144",31);
        populateEdgeVertexJoinData(db, "38387668", "453654402",32);
        populateEdgeVertexJoinData(db, "38387668", "1708396900",33);
        populateEdgeVertexJoinData(db, "38387668", "453654327",34);
        populateEdgeVertexJoinData(db, "38387668", "453654325",35);
        populateEdgeVertexJoinData(db, "38387668", "453654324",36);
        populateEdgeVertexJoinData(db, "38387668", "453654322",37);
        populateEdgeVertexJoinData(db, "38387668", "453654332",38);
        populateEdgeVertexJoinData(db, "38387668", "453654330",39);
        populateEdgeVertexJoinData(db, "38387668", "453654365",40);
        populateEdgeData(db, "39159184","469073348","469073348");
        populateEdgeVertexJoinData(db, "39159184", "469073348",0);
        populateEdgeVertexJoinData(db, "39159184", "469073349",1);
        populateEdgeVertexJoinData(db, "39159184", "469073350",2);
        populateEdgeVertexJoinData(db, "39159184", "469073351",3);
        populateEdgeVertexJoinData(db, "39159184", "469073348",4);
        ...
        populateEdgeData(db, "48211367","612766067","612766067");
        populateEdgeVertexJoinData(db, "48211367", "612766067",0);
        populateEdgeVertexJoinData(db, "48211367", "612766068",1);
        populateEdgeVertexJoinData(db, "48211367", "612766069",2);
        populateEdgeVertexJoinData(db, "48211367", "612766070",3);
        populateEdgeVertexJoinData(db, "48211367", "612766071",4);
        populateEdgeVertexJoinData(db, "48211367", "612766072",5);
        populateEdgeVertexJoinData(db, "48211367", "612983976",6);
        populateEdgeVertexJoinData(db, "48211367", "612983977",7);
        populateEdgeVertexJoinData(db, "48211367", "612983258",8);
        populateEdgeVertexJoinData(db, "48211367", "613015967",9);
        populateEdgeVertexJoinData(db, "48211367", "612766073",10);
        populateEdgeVertexJoinData(db, "48211367", "612766074",11);
        populateEdgeVertexJoinData(db, "48211367", "612766075",12);
        populateEdgeVertexJoinData(db, "48211367", "612766076",13);
        populateEdgeVertexJoinData(db, "48211367", "612766077",14);
        populateEdgeVertexJoinData(db, "48211367", "612766067",15);
        ...
        populateEdgeData(db, "48236799","613030448","613030448");
        populateEdgeVertexJoinData(db, "48236799", "613030448",0);
        populateEdgeVertexJoinData(db, "48236799", "613030450",1);
        populateEdgeVertexJoinData(db, "48236799", "613030458",2);
        populateEdgeVertexJoinData(db, "48236799", "613030460",3);
        populateEdgeVertexJoinData(db, "48236799", "613030462",4);
        populateEdgeVertexJoinData(db, "48236799", "613030465",5);
        populateEdgeVertexJoinData(db, "48236799", "3729707377",6);
        populateEdgeVertexJoinData(db, "48236799", "613030467",7);
        populateEdgeVertexJoinData(db, "48236799", "3729707378",8);
        populateEdgeVertexJoinData(db, "48236799", "613030469",9);
        populateEdgeVertexJoinData(db, "48236799", "613030471",10);
        populateEdgeVertexJoinData(db, "48236799", "613030472",11);
        populateEdgeVertexJoinData(db, "48236799", "613030473",12);
        populateEdgeVertexJoinData(db, "48236799", "613030474",13);
        populateEdgeVertexJoinData(db, "48236799", "613030475",14);
        populateEdgeVertexJoinData(db, "48236799", "613030476",15);
        populateEdgeVertexJoinData(db, "48236799", "613030478",16);
        populateEdgeVertexJoinData(db, "48236799", "613030480",17);
        populateEdgeVertexJoinData(db, "48236799", "613030482",18);
        populateEdgeVertexJoinData(db, "48236799", "613030485",19);
        populateEdgeVertexJoinData(db, "48236799", "613030448",20);
        populateEdgeData(db, "48237135","613032925","613032925");
        populateEdgeVertexJoinData(db, "48237135", "613032925",0);
        populateEdgeVertexJoinData(db, "48237135", "1792436617",1);
        populateEdgeVertexJoinData(db, "48237135", "613032929",2);
        populateEdgeVertexJoinData(db, "48237135", "1792436613",3);
        populateEdgeVertexJoinData(db, "48237135", "1792436684",4);
        populateEdgeVertexJoinData(db, "48237135", "1792436387",5);
        populateEdgeVertexJoinData(db, "48237135", "613032933",6);
        populateEdgeVertexJoinData(db, "48237135", "1792436393",7);
        populateEdgeVertexJoinData(db, "48237135", "613032935",8);
        populateEdgeVertexJoinData(db, "48237135", "613032938",9);
        populateEdgeVertexJoinData(db, "48237135", "1792436367",10);
        populateEdgeVertexJoinData(db, "48237135", "1792436523",11);
        populateEdgeVertexJoinData(db, "48237135", "613032939",12);
        populateEdgeVertexJoinData(db, "48237135", "613032940",13);
        populateEdgeVertexJoinData(db, "48237135", "613345155",14);
        populateEdgeVertexJoinData(db, "48237135", "613032943",15);
        populateEdgeVertexJoinData(db, "48237135", "613032946",16);
        populateEdgeVertexJoinData(db, "48237135", "613345156",17);
        populateEdgeVertexJoinData(db, "48237135", "613345157",18);
        populateEdgeVertexJoinData(db, "48237135", "1792436540",19);
        populateEdgeVertexJoinData(db, "48237135", "613032925",20);
        populateEdgeData(db, "48271411","636053440","636053440");
        populateEdgeVertexJoinData(db, "48271411", "636053440",0);
        populateEdgeVertexJoinData(db, "48271411", "613345158",1);
        populateEdgeVertexJoinData(db, "48271411", "613345159",2);
        populateEdgeVertexJoinData(db, "48271411", "613345160",3);
        populateEdgeVertexJoinData(db, "48271411", "613345161",4);
        populateEdgeVertexJoinData(db, "48271411", "613345162",5);
        populateEdgeVertexJoinData(db, "48271411", "636053436",6);
        populateEdgeVertexJoinData(db, "48271411", "636053440",7);
        ...
        populateEdgeData(db, "78689233","922765969","922765969");
        populateEdgeVertexJoinData(db, "78689233", "922765969",0);
        populateEdgeVertexJoinData(db, "78689233", "2179870868",1);
        populateEdgeVertexJoinData(db, "78689233", "922765971",2);
        populateEdgeVertexJoinData(db, "78689233", "4225974515",3);
        populateEdgeVertexJoinData(db, "78689233", "4225974510",4);
        populateEdgeVertexJoinData(db, "78689233", "922765980",5);
        populateEdgeVertexJoinData(db, "78689233", "922765981",6);
        populateEdgeVertexJoinData(db, "78689233", "1615754379",7);
        populateEdgeVertexJoinData(db, "78689233", "4225974517",8);
        populateEdgeVertexJoinData(db, "78689233", "1615754381",9);
        populateEdgeVertexJoinData(db, "78689233", "922765969",10);
        ...
        populateEdgeData(db, "167907357","1792436352","1792436352");
        populateEdgeVertexJoinData(db, "167907357", "1792436352",0);
        populateEdgeVertexJoinData(db, "167907357", "3729707353",1);
        populateEdgeVertexJoinData(db, "167907357", "1792436562",2);
        populateEdgeVertexJoinData(db, "167907357", "1792436447",3);
        populateEdgeVertexJoinData(db, "167907357", "3729707352",4);
        populateEdgeVertexJoinData(db, "167907357", "1792436423",5);
        populateEdgeVertexJoinData(db, "167907357", "1792436486",6);
        populateEdgeVertexJoinData(db, "167907357", "1792436725",7);
        populateEdgeVertexJoinData(db, "167907357", "1792436672",8);
        populateEdgeVertexJoinData(db, "167907357", "1792436579",9);
        populateEdgeVertexJoinData(db, "167907357", "1792436546",10);
        populateEdgeVertexJoinData(db, "167907357", "1792436698",11);
        populateEdgeVertexJoinData(db, "167907357", "1792436519",12);
        populateEdgeVertexJoinData(db, "167907357", "1792436398",13);
        populateEdgeVertexJoinData(db, "167907357", "1792436386",14);
        populateEdgeVertexJoinData(db, "167907357", "1792436362",15);
        populateEdgeVertexJoinData(db, "167907357", "1792436352",16);
        populateEdgeData(db, "167907358","1792436673","1792436673");
        populateEdgeVertexJoinData(db, "167907358", "1792436673",0);
        populateEdgeVertexJoinData(db, "167907358", "1792436390",1);
        populateEdgeVertexJoinData(db, "167907358", "1792436693",2);
        populateEdgeVertexJoinData(db, "167907358", "1792436695",3);
        populateEdgeVertexJoinData(db, "167907358", "1792436577",4);
        populateEdgeVertexJoinData(db, "167907358", "1792436388",5);
        populateEdgeVertexJoinData(db, "167907358", "1792436689",6);
        populateEdgeVertexJoinData(db, "167907358", "1792436609",7);
        populateEdgeVertexJoinData(db, "167907358", "1792436621",8);
        populateEdgeVertexJoinData(db, "167907358", "1792436673",9);
        ...
        populateEdgeData(db, "369371197","3731660187","3731660187");
        populateEdgeVertexJoinData(db, "369371197", "3731660187",0);
        populateEdgeVertexJoinData(db, "369371197", "3731660188",1);
        populateEdgeVertexJoinData(db, "369371197", "3731660189",2);
        populateEdgeVertexJoinData(db, "369371197", "3731660190",3);
        populateEdgeVertexJoinData(db, "369371197", "3731660191",4);
        populateEdgeVertexJoinData(db, "369371197", "3731660192",5);
        populateEdgeVertexJoinData(db, "369371197", "3731660193",6);
        populateEdgeVertexJoinData(db, "369371197", "3731660194",7);
        populateEdgeVertexJoinData(db, "369371197", "3731660195",8);
        populateEdgeVertexJoinData(db, "369371197", "3731660196",9);
        populateEdgeVertexJoinData(db, "369371197", "3731660197",10);
        populateEdgeVertexJoinData(db, "369371197", "3731660198",11);
        populateEdgeVertexJoinData(db, "369371197", "3731660199",12);
        populateEdgeVertexJoinData(db, "369371197", "3731660200",13);
        populateEdgeVertexJoinData(db, "369371197", "3731660201",14);
        populateEdgeVertexJoinData(db, "369371197", "3731660202",15);
        populateEdgeVertexJoinData(db, "369371197", "3731660203",16);
        populateEdgeVertexJoinData(db, "369371197", "3731660204",17);
        populateEdgeVertexJoinData(db, "369371197", "3731660187",18);
        ...
        populateEdgeData(db, "475846709","4695334935","4695334935");
        populateEdgeVertexJoinData(db, "475846709", "4695334935",0);
        populateEdgeVertexJoinData(db, "475846709", "4695334936",1);
        populateEdgeVertexJoinData(db, "475846709", "4695334937",2);
        populateEdgeVertexJoinData(db, "475846709", "4695334938",3);
        populateEdgeVertexJoinData(db, "475846709", "4695334935",4);
        populateEdgeData(db, "475846710","4695334939","4695334939");
        populateEdgeVertexJoinData(db, "475846710", "4695334939",0);
        populateEdgeVertexJoinData(db, "475846710", "4695334940",1);
        populateEdgeVertexJoinData(db, "475846710", "4695334941",2);
        populateEdgeVertexJoinData(db, "475846710", "4695334942",3);
        populateEdgeVertexJoinData(db, "475846710", "4695334939",4);
